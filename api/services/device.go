...
type DeviceService interface {
	...
	GetDevicePosition(ctx context.Context, uid models.UID) (*models.DevicePosition, error)
}
...
func (s *service) GetDevicePosition(ctx context.Context, uid models.UID) (*models.DevicePosition, error) {
	return s.store.DeviceGetPosition(ctx, uid)
}
